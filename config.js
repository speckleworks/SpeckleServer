...
module.exports = {
  ...
  speckle: {
    serverName: process.env.SPECKLE_NAME || 'Speckle OSX Localhost',
    restApi: process.env.SPECKLE_URL || 'http://127.0.0.1:8080/api/v1',
    ws: process.env.SPECKLE_SOCKET || 'ws://127.0.0.1:8080'
  },
  mongo: {
