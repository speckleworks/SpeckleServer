...
// (2) Check in the db for existing objects by hash & map their _id to the 
...
module.exports = ( req, res ) => {
  ...
  Promise.all( req.body.objects.reduce( ( arr, o ) => o._id !== undefined ? [ SpeckleObject.update( { _id: o._id }, o ), ...arr ] : arr, [ ] ) )
