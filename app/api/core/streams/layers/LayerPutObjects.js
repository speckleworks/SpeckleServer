...
module.exports = ( req, res ) => {
  ...
  DataStream.findOne( { streamId: req.params.streamId } )
    ...
    .then( results => {
      ...
      dbStream.objects.splice( targetLayer.startIndex, targetLayer.objectCount, ...req.body.objects.map( o => o._id ) )
      let diffCount = req.body.objects.length - targetLayer.objectCount
